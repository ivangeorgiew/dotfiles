...
set updatetime=800                         " time after with the CursorHold events will fire
...
" import-js mappings
nnoremap <silent> <leader>ia :ImportJSWord<CR>:update<CR>:silent! normal! zO<CR>
nnoremap <silent> <leader>if :ImportJSFix<CR>:update<CR>:silent! normal! zO<CR>
